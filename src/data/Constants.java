...
public class Constants {
    ...
    public static final BaseBody SUN = new Star(
            "sun",1.9891e30, 6.957e8,
            Color.YELLOW
    );
    public static final BaseBody MERCURY = new Planet(
    ...
    public static final BaseBody VENUS = new Planet(
    ...
    public static final BaseBody EARTH = new Planet(
    ...
    public static final BaseBody MARS = new Planet(
            "mars",6.39e23, 3.39e6,
    ...
    public static final BaseBody JUPITER = new Planet(
    ...
    public static final BaseBody SATURN = new Planet(
    ...
    public static final BaseBody URANUS = new Planet(
    ...
    public static final BaseBody NEPTUNE = new Planet(
    ...
    public static final BaseBody MOON = new Planet(
    ...
    public static final BaseBody TITAN = new Planet(
